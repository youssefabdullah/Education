...
import { Paper, TableCell, TableContainer, Table, TableHead, Button, Grid, CircularProgress, TableRow, TableBody } from '@material-ui/core'; import { db, fire, userRef } from '../../config/fire';
    ...
    useEffect(() => {
        ...
        fire.auth().onAuthStateChanged(function (user) {
            if (user) {
                ...
                setId(user.uid)
                console.log(Id)
                db.collection('Junior2/Ex/2').onSnapshot(snapshot => {
                    const Student = [];
